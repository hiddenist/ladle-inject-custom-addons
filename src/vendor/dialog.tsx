...
/**
 * @see https://reach.tech/dialog#dialog-props
 */
...
type PropsForHtmlDiv = React.DetailedHTMLProps<
  React.HTMLAttributes<HTMLDivElement>,
  HTMLDivElement
>

/**
 * @see https://reach.tech/dialog/#dialogoverlay-props
 */
interface DialogOverlayProps
  extends React.PropsWithChildren<PropsForHtmlDiv>,
    Pick<
      DialogProps,
      "isOpen" | "onDismiss" | "initialFocusRef" | "allowPinchZoom"
    > {
...
/**
 * @see https://reach.tech/dialog/#dialogcontent-props
 */
interface DialogContentProps extends React.PropsWithChildren<PropsForHtmlDiv> {}
...
const DialogOverlay: React.FC<DialogOverlayProps> =
  /*#__PURE__*/ forwardRefWithAs(function DialogOverlay(_ref, forwardedRef) {
...
const DialogContent: React.FC<DialogContentProps> =
  /*#__PURE__*/ forwardRefWithAs(function DialogContent(_ref3, forwardedRef) {
...
/** @type {any} */
const Dialog: React.FC<DialogProps> = /*#__PURE__*/ forwardRefWithAs(
